...
//                   <button onClick={goTo('/admin')} className="text-left p-1 font-bold rounded hover:bg-gray-500 text-base">
//                     관리자페이지
//                   </button>
//                 ) : (
//                   <button onClick={goTo('/myPage')} className="text-left p-1 font-bold rounded hover:bg-gray-500 text-base">
//                     마이페이지
//                   </button>
//                 )}
//                 <button onClick={handleLogout} className="text-left p-1 font-bold rounded hover:bg-gray-500 text-base">
//                   로그아웃
//                 </button>
//               </div>
//             )
//           ) : (
//             <button onClick={goTo('/login')} className="text-left p-1 font-bold rounded hover:bg-gray-500 text-base">
//               로그인
//             </button>
//           )}
//         </div>
