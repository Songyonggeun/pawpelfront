...
const PLACES = [
  ...
  { id: 22, name: '아이조아펫파크 서울점', lat: 37.533507, lng: 126.990254, address: '서울 용산구 녹사평대로32길 28 2층', phone: '0507-1316-1160' },
  { id: 23, name: '로그라운드', lat: 37.569600, lng: 127.031907, address: '서울 성동구 청계천로 494 벽산상가 B동 102호, 103호, 202호', phone: '0507-1343-1147' },
  { id: 24, name: '논오프', lat: 37.530428, lng: 126.866095, address: '서울 양천구 국회대로 279 1층', phone: '0507-1344-7009' },
  { id: 25, name: '홍다다', lat: 37.599119, lng: 127.087523, address: '서울 중랑구 상봉중앙로1길 20 1층', phone: '0507-1483-0680' },
  { id: 26, name: '녹녹', lat: 37.563841, lng: 126.921934, address: '서울 마포구 성미산로 139 1층 녹녹', phone: '0507-1424-1269' },
  { id: 27, name: '브리즈서울 한남', lat: 37.537450, lng: 126.999998, address: '서울 용산구 이태원로55가길 22 1층 브리즈서울', phone: '0507-1463-8962' },
  { id: 28, name: '개뿔', lat: 37.578146, lng: 127.008068, address: '서울 종로구 낙산성곽서1길 26 까페 개뿔 1,2층', phone: '02-765-2019' },
