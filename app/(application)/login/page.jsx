...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (jwtCookie) {
      router.push('/'); // ✅ 로그인한 상태라면 home으로 이동
    }
  }, [router]);
