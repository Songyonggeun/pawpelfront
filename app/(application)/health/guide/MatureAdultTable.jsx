export default function MatureAdultTable() {
  const cellStyle = {
  ...
  const theadStyle = {
    borderTop: '2px solid #b7d56b',
  };
  const theadThStyle = {
    backgroundColor: '#EAF4CC',
    padding: '21px 5px',
    fontWeight: 600,
    fontSize: '18px',
    textAlign: 'center',
    ...
    <table style={{ width: '100%', borderCollapse: 'collapse', borderSpacing: '0' }}>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style={cellStyle}>체온/심박수/체중/청진/혈압, 림프절 검사</td>
          <td style={cellStyle}>1회/년</td>
        ...
        <tr>
          ...
          <td style={cellStyle}>전혈구, 혈청화학, 전해질, SDMA, 호르몬, 담즙산</td>
          <td style={cellStyle}>1회/년</td>
          <td style={cellStyle}></td>
        </tr>
